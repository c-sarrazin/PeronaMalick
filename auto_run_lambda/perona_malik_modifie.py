# Ce programme s'exécute depuis la ligne de commande en lui passant deux arguments i et j. Il a été conçu pour tester automatiquement le comportement de Perona-Malik pour un grand nombre de valeurs de lambda grâce au script Bash lambdas.sh
...
nom = 'auto_run_lambda/resultats/lax'+str(I)+'e-'+str(J)+'.gif'
